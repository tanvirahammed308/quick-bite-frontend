  ...
  const handleReservation = () => {
    Swal.fire<ReservationFormData>({
      ...
      customClass: {
        ...
        confirmButton:
          "bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg",
        cancelButton:
      ...
      preConfirm: (): ReservationFormData | false => {
        ...
        const time = (
          document.getElementById("time") as HTMLSelectElement
        )?.value;

        const guests = (
          document.getElementById("guests") as HTMLSelectElement
        )?.value;
